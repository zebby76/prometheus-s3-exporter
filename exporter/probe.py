...
class ConnectivityProbe:
    ...
    def __init__(self, client, bucket, interval_seconds=60):
        ...
        # allowed to make; then it stays put.
        self._method = None
    ...
    def check_once(self) -> ProbeResult:
        ...
        if error is not None and previous.reachable:
            logging.error("Bucket %s became unreachable: %s", self._bucket, error)
        elif (
            ...
            logging.debug("Bucket %s still unreachable: %s", self._bucket, error)
