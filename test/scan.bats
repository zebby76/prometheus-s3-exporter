...
@test "[$TEST_FILE] Launch Clair Scan for [ $BATS_DOCKER_IMAGE_NAME ] Docker Image" {
  ...
  export BATS_CLAIR_SCAN_DOCKER_IMAGE_NAME="${BATS_DOCKER_IMAGE_NAME:-docker.io/elasticms/admin:rc}"
